  ...
  return (
    <div>
      ...
      <div class="flex flex-row h-80 flex-wrap-reverse">
          <div class="min-w-100 rounded-4x1 flex-1 text-left content-around px-32">
              <p class="text-l">Recyclix was made by Anirudh Gali, Pratyush Grover, and Daniel Briggs for sunhacks 2025 at ASU</p>
          </div>
          <div class="text-wrap min-w-100 rounded-4x1 flex-1 text-center content-around px-32">
